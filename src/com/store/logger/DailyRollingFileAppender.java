...
public class DailyRollingFileAppender extends FileAppender {
    ...
    public void activateOptions() {
        ...
        String datedFilename = configFileName+sdf.format(now);
        try {
            setFile(datedFilename, fileAppend, bufferedIO, bufferSize);
        }
        catch(java.io.IOException e) {
            errorHandler.error("setFile("+datedFilename+","+fileAppend+") call failed.",
